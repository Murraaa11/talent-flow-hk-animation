class FlowLegend {
  constructor({ container, color, x, flowValues, tickValues, direction}) {
  ...
  defineGradient() {
    ...
    this.defs
      ...
      .attr("id", "flow-legend-gradient-"+this.direction)
      .attr("x1", 0)
      .attr("y1", 0)
      .attr("x2", 1)
      .attr("y2", 0)
  ...
  render() {
    ...
    flow
      ...
      .attr("fill", "url(#flow-legend-gradient-"+this.direction+")");
    flow
      .append("line")
