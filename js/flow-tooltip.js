class FlowTooltip {
  ...
  init() {
    ...
    this.outboundPie = new FlowPie({
      ...
      color: this.color.inbounds("outbound"),
    });
    this.value = this.row
      .append("div")
      .attr(
    ...
    this.inboundPie = new FlowPie({
      ...
      color: this.color.inbounds("inbound"),
    });
    this.row
      .append("div")
  ...
  show(d, outbound) {
    ...
    if (outbound){
      this.outboundPie.changeColor(this.color.outbounds("outbound"));
      this.inboundPie.changeColor(this.color.outbounds("inbound"));
    }
    else{
      this.outboundPie.changeColor(this.color.inbounds("outbound"));
      this.inboundPie.changeColor(this.color.inbounds("inbound"));
    }
